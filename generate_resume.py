...
svg_globe = '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path><path d="M2 12h20"></path></svg>'
...
svg_skills = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 16 4-4-4-4"></path><path d="m6 8-4 4 4 4"></path><path d="m14.5 4-5 16"></path></svg>'
...
svg_heart = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path></svg>'
    ...
    <style>
        ...
        * {{
        ...
        .resume-page {{
            ...
            max-height: 297mm;
            display: grid;
            grid-template-columns: 76mm 134mm;
    ...
    <main class="resume-page">
        ...
        <aside class="sidebar">
            ...
            <div class="skills-group">
                <div class="sidebar-title">{svg_skills} Core Technologies</div>
                <div class="skill-item">
                    <div class="skill-header"><span>HTML5 &amp; Modern CSS3</span><span>95%</span></div>
                    <div class="skill-bar-bg"><div class="skill-bar-fill" style="width: 95%;"></div></div>
                </div>
                <div class="skill-item">
                    <div class="skill-header"><span>JavaScript ES6+ &amp; DOM</span><span>92%</span></div>
                    <div class="skill-bar-bg"><div class="skill-bar-fill" style="width: 92%;"></div></div>
                </div>
                <div class="skill-item">
                    <div class="skill-header"><span>Python &amp; Flask REST APIs</span><span>90%</span></div>
                    <div class="skill-bar-bg"><div class="skill-bar-fill" style="width: 90%;"></div></div>
                </div>
                <div class="skill-item">
                    <div class="skill-header"><span>SQLite &amp; Relational Schemas</span><span>88%</span></div>
                    <div class="skill-bar-bg"><div class="skill-bar-fill" style="width: 88%;"></div></div>
                </div>
                <div class="skill-item">
                    <div class="skill-header"><span>Google Gemini Flash AI</span><span>86%</span></div>
                    <div class="skill-bar-bg"><div class="skill-bar-fill" style="width: 86%;"></div></div>
                </div>
            </div>

            <!-- Backend & Data -->
            <div class="skills-group">
                <div class="sidebar-title">{svg_server} Backend &amp; Architecture</div>
                <div class="pill-grid">
                    <span class="pill-tag">REST APIs</span>
                    <span class="pill-tag">Flask Routing</span>
                    <span class="pill-tag">CRUD Logic</span>
                    <span class="pill-tag">JSON Schemas</span>
                    <span class="pill-tag">SQLite Queries</span>
                    <span class="pill-tag">AI Endpoints</span>
                </div>
            </div>
            ...
            <div class="skills-group">
                ...
                <div class="pill-grid">
                    ...
                    <span class="pill-tag">Render Cloud</span>
                    <span class="pill-tag">Responsive UX</span>
                    <span class="pill-tag">Linux CLI</span>
                </div>
            </div>

            <!-- Languages & Soft Skills -->
            <div class="skills-group">
                <div class="sidebar-title">{svg_lang} Languages &amp; Traits</div>
                <div class="pill-grid">
                    <span class="pill-tag">English (Professional)</span>
                    <span class="pill-tag">Tamil (Native)</span>
                    <span class="pill-tag">Clean Architecture</span>
                    <span class="pill-tag">Problem Solver</span>
                </div>
            </div>
        </aside>
        ...
        <section class="main-column">
            ...
            <div class="header-block">
                ...
                <div class="candidate-role">Full-Stack Web Developer &bull; AI Systems Integrator</div>
                <p class="summary-text">
                    Detail-oriented Full-Stack Web Developer and 3rd-year B.Sc. Computer Science student with 2 years of hands-on engineering experience. Specializes in building modern, responsive user interfaces, modular Python &amp; Flask backend APIs, optimized SQLite databases, and intelligent Gemini AI workflows.
                </p>
            </div>

            <!-- Education -->
            <div class="section-block">
                <div class="section-header">{svg_edu} Education &amp; Academics</div>
                <div class="education-card">
                    <div class="edu-details">
                        ...
                        <div class="edu-meta">{svg_calendar} 2023 &ndash; 2026 (3rd Year Pursuing) &bull; Core CS &amp; Software Engineering</div>
                    </div>
                    <div class="score-box">
            ...
            <!-- Flagship Projects -->
            <div class="section-block">
                <div class="section-header">{svg_proj} Featured Flagship Projects</div>
                <div class="projects-wrapper">
                    <!-- Project 1 -->
                    <div class="project-item">
                        <div class="project-top">
                            <div class="project-title">{svg_sparkles} Royal Rose Milk — Sensory Brand Experience</div>
                        </div>
                        <div class="project-bullets">
                            <div class="p-bullet">{svg_check} <span>Engineered an interactive product customizer with dynamic sensory ingredient visualizer and real-time flavor-tint engine.</span></div>
                            <div class="p-bullet">{svg_check} <span>Built responsive, mobile-first luxury UI architecture with 60 FPS CSS micro-interactions and smooth performance optimization.</span></div>
                        </div>
                        <div class="tech-tags">
                            <span class="tech-tag">HTML5</span>
                            <span class="tech-tag">CSS3</span>
                            <span class="tech-tag">JavaScript ES6+</span>
                            <span class="tech-tag">Dynamic DOM</span>
                            <span class="tech-tag">Luxury UX</span>
                        </div>
                    </div>
                    ...
                    <div class="project-item">
                        <div class="project-top">
                            <div class="project-title">{svg_sparkles} Pet Nexa — AI Pet Care &amp; Adoption Ecosystem</div>
                        </div>
                        <div class="project-bullets">
                            <div class="p-bullet">{svg_check} <span>Architected a full-stack platform with appointment scheduling workflows, adoption management, and structured SQLite schema.</span></div>
                            <div class="p-bullet">{svg_check} <span>Integrated Google Gemini Flash AI for automated 24/7 intelligent pet healthcare consultations and responsive triage assistance.</span></div>
                        </div>
                        <div class="tech-tags">
                            <span class="tech-tag">Python</span>
                            <span class="tech-tag">Flask REST APIs</span>
                            <span class="tech-tag">SQLite</span>
                            <span class="tech-tag">Gemini Flash AI</span>
            ...
            <div class="bottom-grid">
                <div class="bottom-card">
                    <div class="bottom-heading">{svg_trophy} Technical Highlights</div>
                    <div class="bullet-item">{svg_check} <span>2+ production-grade web applications architected and deployed.</span></div>
                    <div class="bullet-item">{svg_check} <span>Applied LLM integration using Google Gemini AI APIs.</span></div>
                    <div class="bullet-item">{svg_check} <span>Robust relational database modeling and clean REST endpoints.</span></div>
                </div>
                <div class="bottom-card">
                    <div class="bottom-heading">{svg_sparkles} Engineering Focus</div>
                    <div class="bullet-item">{svg_check} <span>Clean, maintainable code architecture with modular standards.</span></div>
                    <div class="bullet-item">{svg_check} <span>High-performance UI rendering and rapid interactive prototyping.</span></div>
                    <div class="bullet-item">{svg_check} <span>Fast learner, self-motivated problem solver, proactive team player.</span></div>
                </div>
            </div>
        </section>
    </main>
